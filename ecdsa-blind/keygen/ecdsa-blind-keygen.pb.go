...
// 	protoc        v4.25.3
// source: protob/ecdsa-blind-keygen.proto
...
var File_protob_ecdsa_blind_keygen_proto protoreflect.FileDescriptor

var file_protob_ecdsa_blind_keygen_proto_rawDesc = []byte{
...
var (
	file_protob_ecdsa_blind_keygen_proto_rawDescOnce sync.Once
	file_protob_ecdsa_blind_keygen_proto_rawDescData = file_protob_ecdsa_blind_keygen_proto_rawDesc
)

func file_protob_ecdsa_blind_keygen_proto_rawDescGZIP() []byte {
	file_protob_ecdsa_blind_keygen_proto_rawDescOnce.Do(func() {
		file_protob_ecdsa_blind_keygen_proto_rawDescData = protoimpl.X.CompressGZIP(file_protob_ecdsa_blind_keygen_proto_rawDescData)
	})
...
func init() { file_protob_ecdsa_blind_keygen_proto_init() }
func file_protob_ecdsa_blind_keygen_proto_init() {
	if File_protob_ecdsa_blind_keygen_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_protob_ecdsa_blind_keygen_proto_goTypes,
		DependencyIndexes: file_protob_ecdsa_blind_keygen_proto_depIdxs,
		MessageInfos:      file_protob_ecdsa_blind_keygen_proto_msgTypes,
	}.Build()
	File_protob_ecdsa_blind_keygen_proto = out.File
	file_protob_ecdsa_blind_keygen_proto_rawDesc = nil
	file_protob_ecdsa_blind_keygen_proto_goTypes = nil
	file_protob_ecdsa_blind_keygen_proto_depIdxs = nil
}
