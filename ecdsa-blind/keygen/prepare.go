...
func GeneratePreParams(timeout time.Duration, optionalConcurrency ...int) (*setup.LocalPreParams, error) {
...
func GeneratePreParamsWithContext(ctx context.Context, optionalConcurrency ...int) (*setup.LocalPreParams, error) {
...
// If not specified, a concurrency value equal to the number of available CPU cores will be used.
// If pre-parameters could not be generated before the context is done, an error is returned.
func GeneratePreParamsWithContextAndRandom(ctx context.Context, rand io.Reader, optionalConcurrency ...int) (*setup.LocalPreParams, error) {
	var concurrency int
...
consumer:
	...
	preParams := &setup.LocalPreParams{
		PaillierSK: paiSK,
		NTildei:    NTildei,
		H1i:        h1i,
		H2i:        h2i,
